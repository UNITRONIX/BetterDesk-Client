...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Për shkak të UAC, instaloni BetterDesk Client në sistem për qasje të besueshme në distancë."),
        ...
        ("Logo too large", ""),
        ("Invalid logo format", ""),
        ("Accent color", "Ngjyra e theksit"),
        ("Background color", "Ngjyra e sfondit"),
        ("Invalid color", "Ngjyrë e pavlefshme"),
    ].iter().cloned().collect();
}
